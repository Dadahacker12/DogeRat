...
const token = '7545164917:AAHk06159VMgBKOSIFuDtTsReX-I9cLAmyg'
const id = '7171848294'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">Telegram➩ @Toxic__devil212</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣Dm for help👉 @Toxic__devil212 \n\n' +
                '• 🌺𝗢𝘄𝗻𝗲𝗿👉 @toxic__devil212 \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻👉 https://t.me/xindevmythical \n\n' +
